...
# NOTE gounaol: Skyfield solar declination is also computed by skyfield.solar_geometry.calculate_solar_hour_angle_declination_skyfield()
# NOTE: The function calculate_solar_declination_skyfield is not used !
