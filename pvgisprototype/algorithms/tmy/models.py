...
PLOT_FUNCTIONS: Dict[TMYStatisticModel, Callable] = {
    TMYStatisticModel.tmy: plot_tmy,  # Add the function for 'tmy_with_annotations'
    FinkelsteinSchaferStatisticModel.ranked: plot_ranked_finkelstein_schafer_statistic,
    FinkelsteinSchaferStatisticModel.weighted: lambda data: plot_finkelstein_schafer_statistic(
        data, plot_path="weighted_finkelstein_schafer_statistic.png"
    ),
