...
from pvgisprototype.models.noaa.function_models import CalculateTrueSolarTimeNOAAInput
from pvgisprototype.models.noaa.function_models import CalculateTrueSolarTimeNOAATimeSeriesInput
