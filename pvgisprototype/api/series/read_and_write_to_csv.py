...
def main():
    ...
    data_1 = xr.open_dataset(time_series_1).sel(lon=longitude, lat=latitude, method='nearest')
    data_2 = xr.open_dataset(time_series_2).sel(lon=longitude, lat=latitude, method='nearest')
