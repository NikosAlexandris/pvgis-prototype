def generate_citation_text():
    citation = {
        ...
        "components": [
            {"name": "Web API", "description": "Entry level guide to get up and running quickly."},
            {"name": "CLI", "description": "Collection of command line tools for interactive use."},
            {"name": "Python API", "description": "For advanced users and programmers with examples and source code documentation."},
            {"name": "Development", "description": "Contribution guidelines, adding new features, and testing."}
        ],
        "support": {
        ...
        "badges": [
            {"name": "pipeline status", "url": "https://gitlab.jrc.ec.europa.eu/jrc-projects/pvgis/pvis-be-prototype/badges/mkdocs/pipeline.svg"},
            {"name": "coverage report", "url": "https://gitlab.jrc.ec.europa.eu/jrc-projects/pvgis/pvis-be-prototype/badges/mkdocs/coverage.svg"},
            {"name": "latest release", "url": "https://gitlab.jrc.ec.europa.eu/jrc-projects/pvgis/pvis-be-prototype/-/badges/release.svg"}
        ]
    }
    return citation
