...
from pvgisprototype.algorithms.pelland.spectral_effect import calculate_spectral_factor_pelland
from pvgisprototype.algorithms.mihaylov.spectral_effect import calculate_spectral_factor_mihaylow
...
def model_spectral_factor(
    ...
    if spectral_factor_model.value == SpectralMismatchModel.mihaylov:

        spectral_factor = calculate_spectral_factor_mihaylow(
            irradiance=irradiance,
