...
GLOBAL_HORIZONTAL_IRRADIANCE_COLUMN_NAME = 'Global horizontal'
DIRECT_INCLINED_IRRADIANCE_COLUMN_NAME = 'Direct'
DIRECT_HORIZONTAL_IRRADIANCE_COLUMN_NAME = 'Direct horizontal'
DIFFUSE_INCLINED_IRRADIANCE = 'Diffuse'
DIFFUSE_INCLINED_IRRADIANCE_COLUMN_NAME = '🗤 Diffuse'
DIFFUSE_HORIZONTAL_IRRADIANCE_COLUMN_NAME = 'Diffuse horizontal'
DIFFUSE_CLEAR_SKY_IRRADIANCE_COLUMN_NAME = 'Diffuse clear-sky'
REFLECTED_INCLINED_IRRADIANCE_COLUMN_NAME = 'Reflected'
REFLECTED_HORIZONTAL_IRRADIANCE_COLUMN_NAME = 'Reflected horizontal'
EXTRATERRESTRIAL_NORMAL_IRRADIANCE_COLUMN_NAME = 'Extra-Normal'
EXTRATERRESTRIAL_HORIZONTAL_IRRADIANCE_COLUMN_NAME = 'Extra-Horizontal'
