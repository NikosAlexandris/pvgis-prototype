...
EFFECTIVE_DIRECT_IRRADIANCE_COLUMN_NAME = f'Direct {SYMBOL_EFFECTIVE}'
DIRECT_INCLINED_IRRADIANCE_COLUMN_NAME = f'Direct {SYMBOL_INCLINED}'
DIRECT_HORIZONTAL_IRRADIANCE_COLUMN_NAME = f'Direct {SYMBOL_HORIZONTAL}'
DIRECT_NORMAL_IRRADIANCE_COLUMN_NAME = f'Direct {SYMBOL_NORMAL}'
