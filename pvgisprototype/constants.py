...
LONGITUDE_COLUMN_NAME = 'ϑ ' + LONGITUDE_NAME
LATITUDE_COLUMN_NAME = 'ϕ ' + LATITUDE_NAME
TIME_ALGORITHM_COLUMN_NAME = '⏲ ' + TIME_ALGORITHM_NAME  # Algorithm
DECLINATION_COLUMN_NAME = '∢ ' + DECLINATION_NAME
HOUR_ANGLE_COLUMN_NAME = f'🕛 ' + HOUR_ANGLE_NAME
...
AZIMUTH_DIFFERENCE_COLUMN_NAME = 'Δ⦬ ' + AZIMUTH_NAME
