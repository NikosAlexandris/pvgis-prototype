...
async def get_optimised_surface_position(
    ...
    if csv:
        ...
        csv_content += (
                    f"{convert_float_to_degrees_if_requested(optimised_surface_position['surface_orientation'].value, angle_output_units)},{convert_float_to_degrees_if_requested(optimised_surface_position['surface_tilt'].value, angle_output_units)}"
                    )
