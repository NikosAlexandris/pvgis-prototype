...
fastapi_query_longitude = Query(
    ...
    ge=LONGITUDE_MINIMUM_SARAH_EXTENT,  # LONGITUDE_MINIMUM,
    le=LONGITUDE_MAXIMUM_SARAH_EXTENT,  # LONGITUDE_MAXIMUM,
)
...
fastapi_query_latitude = Query(
    ...
    ge=LATITUDE_MINIMUM_SARAH_EXTENT,  # LATITUDE_MINIMUM,
    le=LATITUDE_MAXIMUM_SARAH_EXTENT,  # LATITUDE_MAXIMUM,
)
