...
def print_irradiance_table(
    ...
    solar_positioning_algorithm = data_model_components.get(POSITIONING_ALGORITHM_COLUMN_NAME, None)
    ...
    perigee_offset = data_model_components.get(ECCENTRICITY_PHASE_OFFSET_COLUMN_NAME, None)
    ...
    if solar_constant and perigee_offset and eccentricity_correction_factor:
        ...
        caption += f"{ECCENTRICITY_PHASE_OFFSET_COLUMN_NAME} : {perigee_offset}, "
