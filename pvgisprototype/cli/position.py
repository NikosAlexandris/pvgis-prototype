...
def hour_angle(
    ...
    typer.echo(f'Hour angle: {hour_angle} {hour_angle_units}')
...
def sunrise(
    ...
    hour_angle, hour_angle_unit = calculate_hour_angle_sunrise(
            latitude,
            surface_tilt,
            solar_declination,
            angle_output_units=angle_output_units,
    ...
    typer.echo(f'Hour angle at {output_latitude} at sun rise/set: {hour_angle} {hour_angle_unit}')
