...
@log_function_call
def get_extraterrestrial_horizontal_irradiance_series(
    ...
    if not quiet:
        if verbose > 0:
            ...
            flat_list = (
                extraterrestrial_horizontal_irradiance_series.value.flatten().astype(str)
            )
    ...
    if statistics:
        ...
        print_series_statistics(
            data_array=extraterrestrial_horizontal_irradiance_series.value,
            timestamps=timestamps,
            groupby=groupby,
            title="Extraterrestrial horizontal irradiance",
            rounding_places=rounding_places,
        )
    if uniplot:
        ...
        uniplot_data_array_series(
            ...
            lines=True,
            supertitle=extraterrestrial_horizontal_irradiance_series.supertitle,
            title=extraterrestrial_horizontal_irradiance_series.title,
            label=extraterrestrial_horizontal_irradiance_series.label,
