A_PRIMER_ON_SOLAR_GEOMETRY = """
    ...
    and a moment in time, depends on the [darkblue]Solar Incidence[/darkblue] angle.

    To calculcate the critical solar incidence angle, PVGIS requires :
    - the relative [cyan]Latitude[/cyan] and [cyan]Longitude[/cyan] coordinates of the surface in question
    - the [cyan]Surface Tilt[/cyan] and [cyan]Surface Orientation[/cyan] angles
    - the [cyan]Solar Declination[/cyan] and the [cyan]Solar Hour[/cyan] angles
    - a [cyan]Timestamp[/cyan] from which to derive latter two 

    [bold]First in order is[/bold] the calculation of the position of the Earth in its orbit
    ...
    [bold]Second is the[/bold] [cyan]Equation of Time[/cyan] measured in minutes that
    ...
    [bold]Next is the[/bold] [cyan]True solar time[/cyan], also known as the [cyan]Apparent solar time[/cyan]
    upon which depends the calculation of the [cyan]Solar hour angle[/cyan].
    ...
    - [cyan]Fractional year[/cyan] ⊂ [cyan]Solar declination[/cyan]
      ([reverse]NOAA[/reverse])

    or

    - ([cyan]Fractional year[/cyan], [cyan]Eccentricity correction[/cyan],
      [cyan]Perigee offset[/cyan]) ⊂ [cyan]Solar declination[/cyan]
      ([reverse]Need Reference Here![/reverse])
    """
