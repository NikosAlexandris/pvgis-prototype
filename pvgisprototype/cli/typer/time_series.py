...
from pvgisprototype.cli.rich_help_panel_names import rich_help_panel_time_series_data
from pvgisprototype.cli.rich_help_panel_names import rich_help_panel_time_series_data_selection
