...
WARNING_NEGATIVE_VALUES = f'[red bold]Warning : I found some negative values[/red bold]'
WARNING_OUT_OF_RANGE_VALUES = f'[yellow bold]Warning : I found some out-of-range values[/yellow bold]'
