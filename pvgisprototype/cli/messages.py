...
WARNING_NEGATIVE_VALUES = f'[bold black on red] Warning [/bold black on red] : I found some [red bold]negative values[/red bold]'
WARNING_OUT_OF_RANGE_VALUES = f'[black on yellow] Warning [/black on yellow] : [bold yellow]I found some values out of the expected range[/bold yellow]'
