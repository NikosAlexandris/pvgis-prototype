...
def plot_extraterrestrial_irradiance(
    ...
    extraterrestrial_irradiance_series = np.vectorize(calculate_extraterrestrial_normal_irradiance)(timestamps)
    ...
    perigee_value = calculate_extraterrestrial_normal_irradiance(perigee_timestamp)
    ...
    apogee_value = calculate_extraterrestrial_normal_irradiance(apogee_timestamp)
