...
from pvgisprototype.web_api.config import get_environment, get_settings
...
from pvgisprototype.web_api.fastapi.configure import configure_application
from pvgisprototype.web_api.middleware.caching import CacheLifecycleMiddleware
from pvgisprototype.web_api.middleware.logging import (
    LogRequestIDMiddleware,
    response_time_request,
)
from pvgisprototype.web_api.middleware.functiontrace import profile_request_functiontrace
from pvgisprototype.web_api.middleware.pyinstrument import profile_request_pyinstrument
from pvgisprototype.web_api.middleware.scalene import profile_request_scalene
from pvgisprototype.web_api.middleware.yappi import profile_request_yappi
from pvgisprototype.web_api.fastapi.openapi import customise_openapi, tags_metadata
from pvgisprototype.web_api.endpoint.performance.broadband import (
    get_photovoltaic_performance_analysis,
)
from pvgisprototype.web_api.endpoint.performance.spectral_effect import (
    get_spectral_factor_series,
)
from pvgisprototype.web_api.endpoint.position.overview import (
    get_calculate_solar_position_overview,
)
from pvgisprototype.web_api.endpoint.power.broadband import (
    get_photovoltaic_power_series_advanced,
)
from pvgisprototype.web_api.endpoint.power.broadband_demo import get_photovoltaic_power_series
from pvgisprototype.web_api.endpoint.power.broadband_multi import (
    get_photovoltaic_power_output_series_multi,
)
from pvgisprototype.web_api.endpoint.surface.optimise import get_optimised_surface_position
from pvgisprototype.web_api.endpoint.tmy import get_typical_meteorological_variable
...
data_directory = current_file.parent / "web_api/endpoint/data"
...
- <em>Intended coverage</em> over Europe & Africa 🌍, largely Asia 🌏 and the Americas 🌎
- <span style="color:red">**This application is limited to** longitudes ranging in [`6.627`, `18.527`] and latitudes [`35.491`, `47.091`].

### See also

For detailed information and structured content,
please refer to the
[PVGIS Documentation](http://localhost:8000/documentation/).
...
version = f"commit {commit_hash}, {commit_date}"
app = ExtendedFastAPI(
...
app.add_middleware(CacheLifecycleMiddleware)
