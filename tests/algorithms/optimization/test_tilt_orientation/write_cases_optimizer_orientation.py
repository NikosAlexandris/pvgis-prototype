...
def write_header_cases():
    ...
    with open('cases_optimizer_tilt_orientation.py', 'w') as fp:
        fp.write(header)


def write_cases_optimizer_tilt_orientation(number_of_cases):
    ...
    for i in range(0,number_of_cases):
        ...
        cases +=("'mode':OptimizerMode.tilt_orientation, \n")
        cases +=("'workers': -1,\n")
    ...
    cases += ("]\n")
    with open('cases_optimizer_tilt_orientation.py', 'a') as fp:
        fp.write(cases)

write_header_cases()
write_cases_optimizer_tilt_orientation(2)
