...
def write_header_cases():
    ...
    with open('cases_optimizer_tilt.py', 'w') as fp:
        fp.write(header)


def write_cases_optimizer_tilt(number_of_cases):
    ...
    for i in range(0,number_of_cases):
        ...
        cases +=("'mode':OptimizerMode.tilt, \n")
        cases +=("'surface_orientation': SurfaceOrientation(value="+str(surface_orientation_value)+", unit='radians'),\n")
        cases +=("'workers': -1,\n")
    ...
    cases += ("]\n")
    with open('cases_optimizer_tilt.py', 'a') as fp:
        fp.write(cases)

write_header_cases()
write_cases_optimizer_tilt(2)
