...
from pvgisprototype.constants import ALTITUDE_NAME, TIME_ALGORITHM_NAME, POSITION_ALGORITHM_NAME, UNITS_NAME, DEGREES
...
@pytest.mark.parametrize(
    ...
    expected_altitude, against_unit", test_cases,
)
...
def test_calculate_solar_altitude(
    longitude,
    latitude,
    timestamp,
    timezone,
    ...
    calculated = calculate_solar_altitude(
        longitude=longitude,
        latitude=latitude,
        timestamp=timestamp,
        timezone=timezone,
