...
def generate_cases_power_broadband_multiple_surfaces(number_of_tests=NUMBER_OF_TESTS):
    ...
    random_number_of_orientation_tilt_values = random.randint(1, 5)
        ...
        parameters = remove_none_values(
            {
                ...
                "surface_orientation": [random.uniform(*surface_orientation_range) for _ in range(random_number_of_orientation_tilt_values)],
                "surface_tilt": [random.uniform(*surface_tilt_range) for _ in range(random_number_of_orientation_tilt_values)],
