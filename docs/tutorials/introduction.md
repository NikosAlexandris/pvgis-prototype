...
Now that we have skimmed throught the introduction,
...
Let us first focus, however,
at the **global** and **direct** components.
These are, after all,
...
Likewise the *diffuse* ***horizontal*** component via :
