...
![Reading time series 1](reading_time_series_data.png)

### 2

Backup plan, storage-wise more costly

![Reading time series 1](reading_time_series_data_alternative.png)

## From A to Ω

![From A to Ω](from_alpha_to_omega.png)
...
![From A to Ω](from_alpha_to_omega_alternative.png)
