...
both of which are derived from the Timestamp of interest.
...
and the Perigee offset) ⊂ Solar declination  PVIS

! hint "Alternative algorithm and Order of dependency"

    - Fractional year ⊂ Solar declination  **NOAA**
    - or (Fractional year, Eccentricity correction, Perigee offset) ⊂ Solar declination  **PVIS**
