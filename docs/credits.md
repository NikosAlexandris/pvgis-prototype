...
title: Credits
description: Attribution section for third-party assets
tags:
  - Credits
  - Attribution
---
...
Icons provided by Material Design, licensed under the Apache License Version 2.0. Material Design icons are copyrighted by the Material Design team. Some icons have been modified for use in this documentation.

# More

Icons used in various diagrams in the Time Series Data page :
